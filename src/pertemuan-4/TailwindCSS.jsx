...
function Spacing(){
    return (
        <div className="bg-white shadow-lg p-6 m-4 rounded-lg">
            ...
            <p className="mt-2 text-red-500">Ini adalah contoh penggunaan padding dan margin di Tailwind.</p>
        </div>
    )
}
...
// rounded (melengkung di ujung)
// mx margin kiri dan kanan, my mergin atas dan bawah
// flex-justify-between (kalau pakai flex utliasn jadi sejajar dg komponen lain, kalau gaada fles tulisannya jadi kebawah)